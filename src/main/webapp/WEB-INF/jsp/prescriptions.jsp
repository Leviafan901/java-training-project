...
<fmt:bundle basename="i18n">
	...
	<fmt:message key="prescriptions.for_client" var="for_client"/>
	...
	<fmt:message key="prescriptions.client_extension" var="client_extension" />
</fmt:bundle>
						...
						<li class="drugsForm__item">
							...
							<form action="request-extention-prescription" method="POST"
								...
								<input name="doctor_id" type="text"
									...
									hidden="hidden" /> <input type="submit" value="${client_extension}"
